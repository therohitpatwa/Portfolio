...
That's why we say **computer understands only Binary or 0 & 1**.
...
Similarly, the computer store the value A in RAM. the ASCII value of A is – 65,
...
No electricity is required to keep the magnets in that state, and data remains safe in other words, data is not lost after power is turned off thats why it is called **non-volatile memory**.  
